...
However, since we can represent a ruler using a vector, we can use the vector representation in \autoref{eq:ruler_measurement}. And again, to distinguish ruler vectors from \enquote{regular} vectors written in an excplicit form, we write the ruler vectors as row vectors:
\begin{align}
